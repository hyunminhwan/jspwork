...
<body>
	...
	<!--  groupingUsed = "false" 는 , 없이 라는 뜻 -->
	그냥 출력 : ${num1} <br>
	세자리마다 구분하여 출력 : <fmt:formatNumber value="${num1}" /><br> <!-- groupingUsed을 안쓰면 기본값 true == 세자리마다 구분자가 있다. -->
	...
	<ul>
		...
		<li>현재 날짜과 시간 : <fmt:formatDate value="${cDate}" type="both"/> </li>
		<li>Medium : <fmt:formatDate value="${cDate}" type="both" dateStyle="medium" /> </li>
		...
		<li>내패턴 : <fmt:formatDate value="${cDate}" type="both" pattern="yyyy-MM-dd(E) hh:mm:ss(a)" />
	</ul>

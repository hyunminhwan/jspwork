...
<body>
	...
	<h3>2. 대소 비교 연산</h3>
	 ...
	 sThree에 담긴값은 '안녕'과 일치합니까? ${sThree == '안녕' } 또는 ${sThree eq '안녕'}<br>
	 ...
	 pOne가 null 입니까? ${pOne == null} 또는 ${pOne eq null} 또는 ${empty pOne}<br>
	 
	 pOne가 null 입니까? ${pOne != null} 또는 ${pOne ne null} 또는 ${not empty pOne}<br>
	 
	 
	 aOne이 비어있습니까? ${empty aOne }<br>
	 aOne이 비어있습니까? ${aOne==null }<br><!-- false 나옴 기본적으로 들어가져있기때문에  -->
	 ...
	 ${big>small && empty aOne} 또는 ${big>small and empty aOne}

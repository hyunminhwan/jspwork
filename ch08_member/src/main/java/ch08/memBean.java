...
public class memBean {
	...
	public memBean(String id, String pwd, String name, String gender, String birthday, String email, String zipcode,
	...
	public String toString() {
		return "memBean [id=" + id + ", pwd=" + pwd + ", name=" + name + ", gender=" + gender + ", birthday=" + birthday
